...
var ImageController = function (_PureComponent) {
  ...
  function ImageController() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ImageController.__proto__ || Object.getPrototypeOf(ImageController)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if ((deltaY < 0 || top < VERTICAL_RANGE) && (deltaY > 0 || bottom > window.innerHeight - VERTICAL_RANGE) || Math.abs(translateY + deltaY - originY * scaleY) < Math.abs(translateY - originY * scaleY)) {
...
/* harmony import */ var _Overlay__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Overlay */ "./src/Overlay/index.jsx");
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./style.css */ "./src/ImageSlides/style.css");
          ...
          react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
              ...
              images.slice(displayMin, displayMax).map(function (url, ind) {
                return (
                  /* eslint-disable */
                  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ImageController__WEBPACK_IMPORTED_MODULE_4__["default"], {
                    onGiveupControl: _this3.getControl,
                    url: url,
                    key: url + (ind + displayMin),
                    focused: ind === _this3.getMedianIndex() })
                );
              })
            )
          )
...
ImageSlides.propTypes = {
  ...
  noTapClose: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleContainerMove = function (e) {
    window.requestAnimationFrame(_this4.move(e));
    e.preventDefault();
    e.stopPropagation();
  };
  ...
  this.move = function (e) {
    return function () {
      if (_this4.state.haveControl) {
        _this4.containerEl.translateX = _this4.containerEl.translateX + parseInt(e.deltaX, 10);
      }
    };
  };
  ...
  this.handleTouchEnd = function (e) {
    ...
    if (_this4.state.haveControl) {
      ...
      var boardWidth = GUTTER_WIDTH + window.innerWidth;
      var baseline = boardWidth * _this4.getMedianIndex();
      if (-_this4.containerEl.translateX - baseline > SWIPE_TRIGGER) {
        var step = _this4.transition(160, 'next');
        if (onChange && _this4.state.index < images.length - 1) {
          onChange(_this4.state.index + 1);
        }
        window.requestAnimationFrame(step);
      } else if (baseline + _this4.containerEl.translateX > SWIPE_TRIGGER) {
        var _step = _this4.transition(160, 'last');
        if (onChange && _this4.state.index > 0) {
          onChange(_this4.state.index - 1);
        }
        window.requestAnimationFrame(_step);
      } else {
        var _step2 = _this4.transition(160, 'noMove');
  ...
  this.handleCloseViewer = function (e) {
